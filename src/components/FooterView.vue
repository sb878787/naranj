            ...
            <div class="block xl:hidden relative">
                <div class="absolute left-0 -top-5">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M13.0414 2.79644L8.40631 5.63474L5.56802 0.999611C4.47355 -0.787731 1.70167 0.90961 2.79614 2.69695L5.63444 7.33208L0.999307 10.1704C-0.787575 11.2646 0.909767 14.0364 2.69665 12.9422L7.33178 10.104L10.1701 14.7391C11.2645 16.5264 14.0364 14.8291 12.9419 13.0417L10.1037 8.40661L14.7388 5.56832C16.5259 4.47399 14.8286 1.70212 13.0414 2.79644Z" fill="#CFCFCF"/>
                    </svg>
                </div>
            </div>
                ...
                <div class="flex-1 mb-12 xl:mb-0 relative xl:static">
                    <div class="flex xl:items-center items-end justify-end xl:justify-start gap-x-4">
                        <div class="xl:flex xl:flex-row flex flex-col xl:items-center items-end">
                            <p class="pt-4 font-YekanM xl:text-2xl text-xl font-semibold text-[#4D4D4D] text-right xl:ml-8 ml-0" dir="ltr">۰۵۱ - ۳۸۳۳۵۹۰۰</p>
                            <p class="pt-4 font-YekanM xl:text-2xl text-xl font-semibold text-[#4D4D4D]" dir="ltr">+۹۸ - ۰۹۳۶ ۳۲۲ ۰۷۱۵</p>
                        </div>
